...
The name of the project is AnimeSearch. By the name, we can understand it will be like searching for an anime by using the name. 

There will be a search bar where we will type what anime we want to search.

Below that we can see the top 5 popular anime which is from MyAnimeList website
